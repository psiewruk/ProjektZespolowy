...
public class UserController {
	...
	public Page<User> getAllUsersByRoleId(@PathVariable(value = "roleId") Long roleId, Pageable pageable) {
	...
	public User updateUser(@PathVariable(value = "roleId") Long roleId, @PathVariable(value = "userId") Long userId,
